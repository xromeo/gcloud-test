...
public class SubscribeWithAvroSchemaExample {
    ...
    public static void main(String... args) throws Exception {
        ...
        String subscriptionId = "dev-stock-on-hand-populated-metadata-inbound-to-gold";
    ...
    public static void subscribeWithAvroSchemaExample(String projectId, String subscriptionId) {
        ...
        SpecificDatumReader<StockOnHandMetadata> reader = new SpecificDatumReader<>(StockOnHandMetadata.getClassSchema());
                    ...
                    try {
                        switch (encoding) {
                            case "BINARY":
                                ...
                                break;
                            case "JSON":
                                decoder = DecoderFactory.get().jsonDecoder(StockOnHandMetadata.getClassSchema(), inputStream);
                        ...
                        StockOnHandMetadata sohMetadata = reader.read(null, decoder);
                        System.out.println(sohMetadata.getRetailProductSKU() + " sku " + sohMetadata.getRetailProductBrand());
